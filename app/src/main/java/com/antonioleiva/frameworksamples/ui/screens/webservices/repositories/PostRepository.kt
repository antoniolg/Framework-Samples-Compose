...
class PostRepository {
     ...
     */
    suspend fun updatePost(postId: Int, post: Post): Result<Post> = withContext(Dispatchers.IO) {
        try {
     ...
     */
    suspend fun deletePost(postId: Int): Result<Unit> = withContext(Dispatchers.IO) {
        try {
